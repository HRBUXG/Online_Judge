...
//        $sql = "delete from `sim` WHERE `s_id` in (select solution_id from solution where `problem_id`=?)";
        $sql = "delete from `sim` WHERE `s_id` in (select solution_id from solution where `problem_id`=? and result !=4)";
        pdo_query($sql, $rjpid);
...
//        $sql = "UPDATE `solution` SET `result`=1 WHERE `solution_id`=?";
        $sql = "UPDATE `solution` SET `result`=1 WHERE `solution_id`=? and result!=4";
        pdo_query($sql, $rjsid);
...
//        $sql = "UPDATE `solution` SET `result`=1 WHERE `contest_id`=?";
        $sql = "UPDATE `solution` SET `result`=1 WHERE `contest_id`=? and result!=4";
        pdo_query($sql, $rjcid);
...
//        $sql = "select solution_id from solution where result=1 and problem_id>0";
        $sql = "select solution_id from solution where result=1 and result!=4 and problem_id>0";

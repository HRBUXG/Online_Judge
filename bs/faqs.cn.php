...
<div id="wrapper">
    ...
    <div id=main>
        ...
        <p><font color=green>Q</font>:这个在线裁判系统使用什么样的编译器和编译选项?<br>
            ...
            Linux. 使用<a href="http://gcc.gnu.org/">GNU GCC/G++</a> 作为C/C++编译器, <a href="http://www.freepascal.org">Free
                Pascal</a> 作为pascal 编译器 ，用 <a
                    href="http://www.oracle.com/technetwork/java/index.html">sun-java-jdk1.6</a> 编译 Java. 对应的编译选项如下:<br>
        </p>
        <table border="1">
            <tr>
                <td>C:</td>
        ...
        <p><font color=green>Q</font>:程序怎样取得输入、进行输出?<br>
            <font color=red>A</font>:你的程序应该从标准输入 stdin('Standard Input')获取输出 并将结果输出到标准输出 stdout('Standard
            ...
            <table width=100% border=0>
                <tr>
                    <td align=right width=65%>
                        ...
                        <a href="http://code.google.com/p/hustoj/source/detail?r=1981"><font color=red>R1981+</font></a>
                    </td>
                </tr>
            </table>
        </center>

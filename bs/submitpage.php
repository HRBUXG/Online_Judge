...
<br>
                ...
                <?php if (isset($OJ_BLOCKLY) && $OJ_BLOCKLY) { ?>
                    <input type=button class="btn btn-danger" onclick="openBlockly()"
                           value="<?php echo $MSG_BLOCKLY_OPEN ?>" style="color:white;background-color:rgb(169,91,128)">
                    <input type=button class="btn btn-primary" onclick="loadFromBlockly() "
                           value="<?php echo $MSG_BLOCKLY_TEST ?>" style="color:white;background-color:rgb(90,164,139)">
                <?php } ?>
            </form>
            <?php if (isset($OJ_BLOCKLY) && $OJ_BLOCKLY) { ?>

    ...
    <div id=main>
        ...
        <div id=center>
            ...
            <form id=simform action="status.php" method="get">
                <?php echo $MSG_PROBLEM_ID ?>:<input class="input-small" style="height:24px" type=text size=4
                                                     name=problem_id
                                                     value='<?php echo htmlentities($problem_id, ENT_QUOTES, 'UTF-8') ?>'>
                <?php echo $MSG_USER ?>:<input class="input-mini" style="height:24px" type=text size=4 name=user_id
                                               value='<?php echo htmlentities($user_id, ENT_QUOTES, 'UTF-8') ?>'>

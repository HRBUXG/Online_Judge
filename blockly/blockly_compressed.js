    ...
    function (a, b) {
        if (goog.inHtmlDocument_()) {
            ...
            if (void 0 === b) if (goog.IS_OLD_IE_) {
                ...
                goog.writeScriptSrcNode_(a); else c.write('<script type="text/javascript">' + goog.protectScriptTag_(b) + "\x3c/script>");
            return !0
        }
        return !1
...
Blockly.Workspace.prototype.deleteVariable = function (a) {
    ...
    if (-1 != c) {
        for (var d = this.getVariableUses(a), e = 0, f; f = d[e]; e++) if ("procedures_defnoreturn" == f.type || "procedures_defreturn" == f.type) {
...
Blockly.Bubble.prototype.renderArrow_ = function () {
    ...
    if (b == d && c == e) a.push("M " + b + "," + c); else {
        ...
        var k = Math.sin(h), n = Math.cos(h), p = this.getBubbleSize(),
            h = (p.width + p.height) / Blockly.Bubble.ARROW_THICKNESS, h = Math.min(h, p.width, p.height) / 4,
            p = 1 - Blockly.Bubble.ANCHOR_RADIUS / f, d = b +
            p * d, e = c + p * e, p = b + h * n, l = c + h * k, b = b - h * n, c = c - h * k,
...
Blockly.Field.getCachedWidth = function (a) {
    var b = a.textContent + "\n" + a.className.baseVal;
    if (Blockly.Field.cacheWidths_ && Blockly.Field.cacheWidths_[b]) var c = Blockly.Field.cacheWidths_[b]; else {
        try {
...
Blockly.Options = function (a) {
    ...
    void 0 === p && (p = !1);
    var l = a.toolboxPosition, l = "end" === l ? !1 : !0,
        l = p ? l ? Blockly.TOOLBOX_AT_TOP : Blockly.TOOLBOX_AT_BOTTOM : l ==
        n ? Blockly.TOOLBOX_AT_RIGHT : Blockly.TOOLBOX_AT_LEFT, m = a.scrollbars;
    void 0 === m && (m = d);
    var q = a.css;
    void 0 === q && (q = !0);
...
Blockly.Scrollbar.prototype.createDom_ = function () {
    this.outerSvg_ = Blockly.utils.createSvgElement("svg", {"class": "blocklyScrollbar" + (this.horizontal_ ? "Horizontal" : "Vertical")}, null);
...
Blockly.utils.tokenizeInterpolation = function (a) {
    ...
    for (var e = null, f = 0; f < c.length; f++) {
        var g = c[f];
        0 == d ? "%" == g ? ((g = a.join("")) && b.push(g), a.length = 0, d = 1) : a.push(g) : 1 == d ? "%" == g ? (a.push(g), d = 0) : "0" <= g && "9" >= g ? (d = 2, e = g, (g = a.join("")) && b.push(g), a.length = 0) : "{" == g ? d = 3 : (a.push("%", g), d = 0) : 2 == d ? "0" <= g && "9" >= g ? e += g : (b.push(parseInt(e, 10)), f--, d = 0) : 3 == d && ("" == g ? (a.splice(0, 0, "%{"), f--, d = 0) : "}" != g ? a.push(g) : (d = a.join(""), /[a-zA-Z][a-zA-Z0-9_]*/.test(d) ? (g = d.toUpperCase(),
            (g = goog.string.startsWith(g, "BKY_") ? g.substring(4) : null) && g in Blockly.Msg ? (d = Blockly.utils.tokenizeInterpolation(Blockly.Msg[g]), b = b.concat(d)) : b.push("%{" + d + "}")) : b.push("%{" + d + "}"), d = a.length = 0))
    }
    (g = a.join("")) && b.push(g);
    c = [];
    ...
    for (var f = 0; f < c; f++) {
        ...
        if ("block" == h || "shadow" == h && !Blockly.Events.recordUndo) {
            var h = Blockly.Xml.domToBlock(g,
                b), k = parseInt(g.getAttribute("x"), 10), g = parseInt(g.getAttribute("y"), 10);
            ...
            if (!isNaN(c) && !isNaN(d)) {
                ...
                do {
                    ...
                    if (!a) for (var k = b.getConnections_(!1),
                                     f = 0, n; n = k[f]; f++) if (n.closest(Blockly.SNAP_RADIUS, new goog.math.Coordinate(c, d)).connection) {
                        a = !0;
                        break
                    }
...
Blockly.WorkspaceSvg.getTopLevelWorkspaceMetrics_ = function () {
    ...
    var b = Blockly.Flyout.prototype.CORNER_RADIUS - 1, c = a.width - b, d = a.height - b,
        e = this.getBlocksBoundingBox(), f = e.width *
...
Blockly.BlockSvg.prototype.onMouseMove_ = function (a) {
    if ("mousemove" == a.type && 1 >= a.clientX && 0 == a.clientY && 0 == a.button) a.stopPropagation(); else {
        ...
        if (Blockly.dragMode_ == Blockly.DRAG_FREE) {
            ...
            e && e != Blockly.highlightedConnection_ && (e.highlight(), Blockly.highlightedConnection_ = e, Blockly.localConnection_ =
                f);
...
Blockly.BlockSvg.prototype.renderCompute_ = function (a) {
    ...
    for (var d = 0, e = 0, f = !1, g = !1, h = !1, k = void 0, n = this.getInputsInline() && !this.isCollapsed(), p = 0, l; l = b[p]; p++) if (l.isVisible()) {
        var m;
        n && k && k != Blockly.NEXT_STATEMENT && l.type != Blockly.NEXT_STATEMENT ? m = c[c.length - 1] : (k = l.type, m = [], m.type = n && l.type !=
        Blockly.NEXT_STATEMENT ? Blockly.BlockSvg.INLINE : l.type, m.height = 0, c.push(m));
        m.push(l);
        ...
        n || p != b.length - 1 ? !n && l.type == Blockly.INPUT_VALUE && b[p + 1] && b[p + 1].type == Blockly.NEXT_STATEMENT &&
        ...
        m.type != Blockly.BlockSvg.INLINE && (m.type == Blockly.NEXT_STATEMENT ? (g = !0, e = Math.max(e, l.fieldWidth)) :
...
Blockly.FieldDropdown.prototype.trimOptions_ = function () {
    ...
    if (goog.isArray(a) && !(2 > a.length)) {
        ...
        var c = Blockly.utils.shortestStringLength(b), e = Blockly.utils.commonWordPrefix(b, c),
        ...
        if ((e || f) && !(c <= e + f)) {
            ...
            for (c = 0; c < a.length; c++) {
                var d =
                    a[c][0], g = a[c][1], d = d.substring(e, d.length - f);
                b[c] = [d, g]
            }
...
Blockly.Variables.flyoutCategory = function (a) {
    ...
    var c = [], d = goog.dom.createDom("button");
    ...
    c.push(d);
    if (0 < b.length) {
        Blockly.Blocks.variables_set && (a = goog.dom.createDom("block"), a.setAttribute("type", "variables_set"), Blockly.Blocks.math_change ?
            a.setAttribute("gap", 8) : a.setAttribute("gap", 24), d = goog.dom.createDom("field", null, b[0]), d.setAttribute("name", "VAR"), a.appendChild(d), c.push(a));
        ...
        for (e = 0; e < b.length; e++) Blockly.Blocks.variables_get && (a = goog.dom.createDom("block"), a.setAttribute("type", "variables_get"), Blockly.Blocks.variables_set && a.setAttribute("gap", 8), d = goog.dom.createDom("field", null, b[e]), d.setAttribute("name", "VAR"), a.appendChild(d), c.push(a))
    }
    return c
};
...
Blockly.Flyout.prototype.show = function (a) {
    ...
    for (var b = [], c = [], d = this.permanentlyDisabled_.length = 0, e; e = a[d]; d++) if (e.tagName) {
        ...
        if ("BLOCK" ==
            f) f = Blockly.Xml.domToBlock(e, this.workspace_), f.disabled && this.permanentlyDisabled_.push(f), b.push({
            type: "block",
            block: f
...
Blockly.Flyout.prototype.placeNewBlock_ = function (a) {
    ...
    var c = b.isMutator ? this.workspace_.getSvgXY(c) : Blockly.utils.getInjectionDivXY_(c),
        d = this.workspace_.scrollX, e = this.workspace_.scale;
    c.x += d / e - d;
...
Blockly.inject = function (a, b) {
    ...
    Blockly.init_(c);
    c.markFocused();
    Blockly.bindEventWithChecks_(e, "focus",
        c, c.markFocused);
    Blockly.svgResize(c);
    return c
};
...
Blockly.createMainWorkspace_ = function (a, b, c, d) {
    ...
    b.readOnly || b.hasScrollbars || e.addChangeListener(function () {
        if (Blockly.dragMode_ == Blockly.DRAG_NONE) {
            ...
            if (a.contentTop <
                d || a.contentTop + a.contentHeight > a.viewHeight + d || a.contentLeft < (b.RTL ? a.viewLeft : c) || a.contentLeft + a.contentWidth > (b.RTL ? a.viewWidth : a.viewWidth + c)) for (var k = e.getTopBlocks(!1), n = 0, p; p = k[n]; n++) {
...
Blockly.bindEventWithChecks_ = function (a, b, c, d, e) {
    ...
    if (b in Blockly.Touch.TOUCH_MAP) for (var k = function (a) {
        g(a);
        f && a.preventDefault()
    }, n = 0, p; p = Blockly.Touch.TOUCH_MAP[b][n]; n++) a.addEventListener(p, k, !1), h.push([a, p, k]);
    return h
};

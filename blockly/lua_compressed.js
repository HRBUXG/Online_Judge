...
Blockly.Lua.lists_setIndex = function (a) {
    ...
    if (("LAST" == d || "FROM_END" == d || "RANDOM" == d) && !b.match(/^\w+$/)) var h = Blockly.Lua.variableDB_.getDistinctName("tmp_list", Blockly.Variables.NAME_TYPE),
        g =
            h + " = " + b + "\n", b = h;
...
Blockly.Lua.controls_if = function (a) {
    var b = 0, c = "", d, e;
    do e = Blockly.Lua.valueToCode(a, "IF" + b, Blockly.Lua.ORDER_NONE) || "false", d = Blockly.Lua.statementToCode(a, "DO" + b), c += (0 < b ? "else" : "") + "if " + e + " then\n" + d, ++b; while (a.getInput("IF" + b));
...
Blockly.Lua.controls_for = function (a) {
    ...
    a = "";
    var g;
    Blockly.isNumber(c) && Blockly.isNumber(d) && Blockly.isNumber(e) ? (g =
...
Blockly.Lua.math_arithmetic = function (a) {
    ...
    }[a.getFieldValue("OP")], c = b[0], b = b[1], d = Blockly.Lua.valueToCode(a, "A", b) || "0";
...
Blockly.Lua.procedures_defreturn = function (a) {
    ...
    Blockly.Lua.STATEMENT_PREFIX && (c = Blockly.Lua.prefixLines(Blockly.Lua.STATEMENT_PREFIX.replace(/%1/g, "'" + a.id + "'"), Blockly.Lua.INDENT) + c);
...
Blockly.Lua.text_join = function (a) {
    ...
    for (var b = [], c = 0; c < a.itemCount_; c++) b[c] = Blockly.Lua.valueToCode(a,

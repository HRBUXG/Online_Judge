...
$content=RemoveXSS($content);
	...
	$sql="UPDATE `news` set `title`=?,`content`=?,user_id=? WHERE `news_id`=?";
	//echo $sql;
...
<form method=POST action='news_edit.php'>
    <p align=center style="padding-top: 20px"><font size=6 color=#333399><b>Edit a Contest</b></font></p>
<input type=hidden name='news_id' value=<?php echo $news_id?>>
<p align=left>Title:<input type=text name=title size=71 style="width:100%" value='<?php echo $title?>'></p>

                    ...
                    <td>
                        <table id=problemstatus>
                            ...
                            <tr class=toprow>
                                ...
                                <td style="cursor:hand"
                                    onclick="sortTable('problemstatus', 3, 'int');"><?php echo $MSG_MEMORY ?>
                                <td style="cursor:hand"
                                    onclick="sortTable('problemstatus', 4, 'int');"><?php echo $MSG_TIME ?>
                                <td><?php echo $MSG_LANG ?>
                                <td style="cursor:hand"
                                    onclick="sortTable('problemstatus', 6, 'int');"><?php echo $MSG_CODE_LENGTH ?>
                                <td><?php echo $MSG_SUBMIT_TIME ?></tr>
                            </thead>
                            <tbody>
                            <?php
                            $cnt = 0;

...
$len = strlen($_POST["summary"]);
if ($len > 140) {
    $err_str = $err_str . "summary Too Long!\\n";
    $err_cnt++;
}
$len = strlen($_POST['email']);
if ($len > 100) {
    ...
    $err_str = $err_str . "Email Type Error!\\n";
    $err_cnt++;
}
...
$sql = "UPDATE `users` SET"
    ...
    . "`summary`=? "
    . "WHERE `user_id`=?";
pdo_query($sql, $password, $nick, $school, $email, $phonenumber, $summary, $user_id);

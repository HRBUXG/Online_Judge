...
Blockly.PHP.controls_if = function (a) {
    var b = 0, c = "", d, e;
    do e = Blockly.PHP.valueToCode(a, "IF" + b, Blockly.PHP.ORDER_NONE) || "false", d = Blockly.PHP.statementToCode(a, "DO" + b), c += (0 < b ? " else " : "") + "if (" + e + ") {\n" + d + "}", ++b; while (a.getInput("IF" + b));
...
Blockly.PHP.controls_repeat_ext = function (a) {
    var b = a.getField("TIMES") ? String(Number(a.getFieldValue("TIMES"))) : Blockly.PHP.valueToCode(a, "TIMES", Blockly.PHP.ORDER_ASSIGNMENT) || "0",
        c = Blockly.PHP.statementToCode(a, "DO"), c = Blockly.PHP.addLoopTrap(c, a.id);
    a = "";
...
Blockly.PHP.controls_whileUntil = function (a) {
    var b = "UNTIL" == a.getFieldValue("MODE"),
        ...
        d = Blockly.PHP.statementToCode(a, "DO"), d = Blockly.PHP.addLoopTrap(d, a.id);
    b && (c = "!" + c);
    return "while (" + c + ") {\n" + d + "}\n"
};
Blockly.PHP.controls_for = function (a) {
    var b = Blockly.PHP.variableDB_.getName(a.getFieldValue("VAR"), Blockly.Variables.NAME_TYPE),
        ...
        g = Blockly.PHP.statementToCode(a, "DO"), g = Blockly.PHP.addLoopTrap(g, a.id);
...
Blockly.PHP.math_arithmetic = function (a) {
    ...
    }[a.getFieldValue("OP")], c = b[0], b = b[1], d = Blockly.PHP.valueToCode(a, "A", b) || "0";
...
Blockly.PHP.procedures_defreturn = function (a) {
    for (var b = [], c = 0, d; d = a.workspace.variableList[c]; c++) -1 == a.arguments_.indexOf(d) && b.push(Blockly.PHP.variableDB_.getName(d, Blockly.Variables.NAME_TYPE));
    ...
    Blockly.PHP.STATEMENT_PREFIX && (e = Blockly.PHP.prefixLines(Blockly.PHP.STATEMENT_PREFIX.replace(/%1/g, "'" + a.id + "'"), Blockly.PHP.INDENT) +
        e);

                ...
                <tr align='center' class='evenrow'>
                    ...
                    <td width='90%' colspan='4'>
                        <form><?php echo $MSG_SEARCH ?>
                            <input type='text' name='search'><input type='submit' value='<?php echo $MSG_SEARCH ?>'>
                        </form>
                    </td>
                </tr>
                <tr align=center class='toprow'>
                    <td width='5'>
                    <td style="cursor:hand" onclick="sortTable('problemset', 1, 'int');" width=10%>
                    ...
                    <td style="cursor:hand" onclick="sortTable('problemset', 4, 'int');" width='5%'>
                        <A><?php echo $MSG_AC ?></A></td>
                    <td style="cursor:hand" onclick="sortTable('problemset', 5, 'int');" width='5%'>
                        <A><?php echo $MSG_SUBMIT ?></A></td>
                </tr>
                </thead>
                <tbody>
                <?php

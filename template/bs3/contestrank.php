...
<div class="container">
    ...
    <div class="jumbotron">
        ...
        <div style="overflow: auto">
            <table id=rank width=99%>
                <thead>
                <tr class=toprow style='text-align:center'>
                    <td class="{sorter:'false'}" width=5% style='text-align:center'>Rank
                    <th width=10% style='text-align:center'>User</th>
                    <th width=10% style='text-align:center'>Nick</th>
                    <th width=5% style='text-align:center'>Solved</th>
                    <th width=5% style='text-align:center'>Penalty</th>
                    <?php
                    for ($i = 0; $i < $pid_cnt; $i++)

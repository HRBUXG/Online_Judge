...
position:fixed; overflow:visible; _position: absolute; _top: expression(documentElement.scrollTop-5 + 'px');">
    ...
    <div style="float:right; width:21%;">
        ...
        _top: expression(documentElement.scrollTop-5 + 'px');">
            <!--标签在这里加-->
            <ul>
                <li id="tag"><h3>视频频标签管理</h3></li>
                <li id="tag"><h3>文件标签管理</h3></li>
                <li id="tag"><h3>队员标签管理</h3></a></li>
                <li id="tag"><h3>问题标签管理</h3></li>
                <li id="tag"><h3>权限标签管理</h3></li>
            </ul>
        </div>
    </div><!--导航div结束-->
    <div id="all_page" style="float:left; width:80%;">
        ...
        <div id="video_tag" style="float:left;">
            <!--第一行头-->
            <div id="video_tag_header"
                 style="float:left; height:60px; width:100%;background-color:#CCC;text-align:center">
            ...
            <div id="tag_video_describe" style="float:left;padding:5px; height:500px; width:33%;
               overflow-y:scroll;scrollbar-base-color:#FFF; scrollbar-face-color:#000">
                ...
                if (isset($_GET['tag_video_describe'])) {
				  ...
				  where tag_video_describe like ?";
                    $tag_video_describe_res = pdo_query($select_tag_video_describe, $tag_video_describe);
                ...
                <table id='video_describe_tag' width='380px' class='table table-striped'>
                    ...
                    <tr class='toprow'>
                        <th class='hidden-xs' width='5%'>
                            <?php echo $MSG_TAG_VIDEO_DESCRIBE_ID ?>
                        </th>
                    ...
                    foreach ($tag_video_describe_res as $row) {
                        $t = 0;
                        echo "<tr>";
                        echo "<td class='hidden-xs'>" . $row['tag_video_describe_id'] . "</td>";
                        echo "<td class='hidden-xs'>" . $row['tag_video_describe'] . "</td>";
                        ?>
                        <td class='hidden-xs'>
            ...
            <div id="first_center1" style="float:left;padding:5px; height:500px; width:33%;
             overflow-y:scroll;scrollbar-base-color:#FFF; scrollbar-face-color:#000">
				...
				where tag_video_source like ?";
                    $tag_video_source_res = pdo_query($select_tag_video_source, $tag_video_source);
                    /*$rows=mysql_affected_rows($link_update_tag);//获取行数
                ...
                <table id='video_describe_tag' width='380px' class='table table-striped'>
                    ...
                    <tr class='toprow'>
                        <th class='hidden-xs' width='5%'>
                            <?php echo $MSG_TAG_VIDEO_SOURCE_ID ?>
                        </th>
                        <th class='hidden-xs' width='20%'>
                    ...
                    foreach ($tag_video_source_res as $row) {
                        $t = 0;
                        echo "<tr>";
                        echo "<td class='hidden-xs'>" . $row['tag_video_source_id'] . "</td>";
                        echo "<td class='hidden-xs'>" . $row['tag_video_source'] . "</td>";
                        ?>
                        <td class='hidden-xs'>
            ...
            <div id="first_center1" style="float:left; padding:5px; height:500px; width:33%;
             overflow-y:scroll;scrollbar-base-color:#FFF; scrollbar-face-color:#000">
				...
				where tag_video_framer like ?";
                    $tag_video_framer_res = pdo_query($select_tag_video_framer, $tag_video_framer);
                    /*$rows=mysql_affected_rows($link_update_tag);//获取行数
                ...
                <table id='video_describe_tag' width='380px' class='table table-striped'>
                    ...
                    <tr class='toprow'>
                        <th class='hidden-xs' width='5%'>
                            <?php echo $MSG_TAG_VIDEO_FRAMER_ID ?>
                        </th>
                        <th class='hidden-xs' width='20%'>
                    ...
                    foreach ($tag_video_framer_res as $row) {
                        $t = 0;
                        echo "<tr>";
                        echo "<td class='hidden-xs'>" . $row['tag_video_framer_id'] . "</td>";
                        echo "<td class='hidden-xs'>" . $row['tag_video_framer'] . "</td>";
                        ?>
                        <td class='hidden-xs'>
        ...
        <div id="file_tag" style="float:left;">
            ...
            overflow-y:scroll;scrollbar-base-color:#FFF; scrollbar-face-color:#000">
				...
				where tag_file_describe like ?";
                    $tag_file_describe_res = pdo_query($select_tag_file_describe, $tag_file_describe);
                    /*$rows = mysql_affected_rows($link_update_tag);//获取行数
                ...
                <table id='video_describe_tag' width='380px' class='table table-striped'>
                    ...
                    <tr class='toprow'>
                        <th class='hidden-xs' width='5%'>
                            <?php echo $MSG_TAG_FILE_DESCRIBE_ID ?>
                        </th>
                        <th class='hidden-xs' width='20%'>
                    ...
                    foreach ($tag_file_describe_res as $row) {
                        $t = 0;
                        echo "<tr>";
                        echo "<td class='hidden-xs'>" . $row['tag_file_describe_id'] . "</td>";
                        echo "<td class='hidden-xs'>" . $row['tag_file_describe'] . "</td>";
                        ?>
                        <td class='hidden-xs'>
            ...
            <div id="secend_center1" style="float:left;padding:5px; height:500px; width:33%;
             overflow-y:scroll;scrollbar-base-color:#FFF; scrollbar-face-color:#000">
				...
				where tag_file_source like ?";
                    $tag_file_source_res = pdo_query($select_tag_file_source, $tag_file_source);
                    //echo "共计".$rows."行 ".$colums."列<br/>";
                } else {
                ...
                <table id='video_describe_tag' width='380px' class='table table-striped'>
                    ...
                    <tr class='toprow'>
                        <th class='hidden-xs' width='5%'>
                            <?php echo $MSG_TAG_FILE_SOURCE_ID ?>
                        </th>
                        <th class='hidden-xs' width='20%'>
                    ...
                    foreach ($tag_file_source_res as $row) {
                        $t = 0;
                        echo "<tr>";
                        echo "<td class='hidden-xs'>" . $row['tag_file_source_id'] . "</td>";
                        echo "<td class='hidden-xs'>" . $row['tag_file_source'] . "</td>";
                        ?>
                        <td class='hidden-xs'>
            ...
            <div id="secend_center1" style="float:left;padding:5px; height:500px; width:33%;
             overflow-y:scroll;scrollbar-base-color:#FFF; scrollbar-face-color:#000">
				...
				where tag_file_framer like ?";
                    $tag_file_framer_res = pdo_query($select_tag_file_framer, $tag_file_framer);
                    //echo "共计".$rows."行 ".$colums."列<br/>";
                } else {
                ...
                <table id='video_describe_tag' width='380px' class='table table-striped'>
                    ...
                    <tr class='toprow'>
                        <th class='hidden-xs' width='5%'>
                            <?php echo $MSG_TAG_FILE_FRAMER_ID ?>
                        </th>
                        <th class='hidden-xs' width='20%'>
                    ...
                    foreach ($tag_file_framer_res as $row) {
                        $t = 0;
                        echo "<tr>";
                        echo "<td class='hidden-xs'>" . $row['tag_file_framer_id'] . "</td>";
                        echo "<td class='hidden-xs'>" . $row['tag_file_framer'] . "</td>";
                        ?>
                        <td class='hidden-xs'>
        ...
        <div id="players_tag" style="float:left">
            ...
            overflow-y:scroll;scrollbar-base-color:#FFF; scrollbar-face-color:#000">
				...
				where tag_player_grade like ?";
                    $tag_player_grade_res = pdo_query($select_tag_player_grade, $tag_player_grade);
                    //echo "共计".$rows."行 ".$colums."列<br/>";
                } else {
                ...
                <table id='player_grade_tag' width='380px' class='table table-striped'>
                    ...
                    <tr class='toprow'>
                        <th class='hidden-xs' width='5%'>
                            <?php echo $MSG_TAG_PLAYER_GRADE_ID ?>
                        </th>
                        <th class='hidden-xs' width='20%'>
                    ...
                    foreach ($tag_player_grade_res as $row) {
                        $t = 0;
                        echo "<tr>";
                        echo "<td class='hidden-xs'>" . $row['tag_player_grade_id'] . "</td>";
                        echo "<td class='hidden-xs'>" . $row['tag_player_grade'] . "</td>";
            ...
            <div id="secend_center1" style="float:left;padding:5px; height:500px; width:33%;
             overflow-y:scroll;scrollbar-base-color:#FFF; scrollbar-face-color:#000">
				...
				where tag_player_professional like ?";
                    $tag_player_professional_res = pdo_query($select_tag_player_professional, $tag_player_professional);
                    //echo "共计".$rows."行 ".$colums."列<br/>";
                } else {
                    $select_tag_player_professional =
                        "select tag_player_professional_id,tag_player_professional from tag_player_professional";
                ...
                <table id='player_professional_tag' width='380px' class='table table-striped'>
                    ...
                    <tr class='toprow'>
                        <th class='hidden-xs' width='5%'>
                            <?php echo $MSG_TAG_PLAYER_PROFESSOIONAL_ID ?>
                        </th>
                        <th class='hidden-xs' width='20%'>
                    ...
                    foreach ($tag_player_professional_res as $row) {
                        $t = 0;
                        echo "<tr>";
                        echo "<td class='hidden-xs'>" . $row['tag_player_professional_id'] . "</td>";
                        echo "<td class='hidden-xs'>" . $row['tag_player_professional'] . "</td>";
                        ?>
                        <td class='hidden-xs'>
            ...
            <div id="secend_center1" style="float:left;padding:5px; height:500px; width:33%;
             overflow-y:scroll;scrollbar-base-color:#FFF; scrollbar-face-color:#000">
				...
				where tag_player_college like ?";
                    $tag_player_college_res = pdo_query($select_tag_player_college, $tag_player_college);
                    //echo "共计".$rows."行 ".$colums."列<br/>";
                } else {
                    $select_tag_player_college =
                        "select tag_player_college_id,tag_player_college from tag_player_college";
                ...
                <table id='player_grade_tag' width='300px' class='table table-striped'>
                    ...
                    <tr class='toprow'>
                        <th class='hidden-xs' width='5%'>
                            <?php echo $MSG_TAG_PLAYER_COLLEGE_ID ?>
                        </th>
                        <th class='hidden-xs' width='20%'>
                    ...
                    foreach ($tag_player_college_res as $row) {
                        $t = 0;
                        echo "<tr>";
                        echo "<td class='hidden-xs'>" . $row['tag_player_college_id'] . "</td>";
                        echo "<td class='hidden-xs'>" . $row['tag_player_college'] . "</td>";
                        ?>
                        <td class='hidden-xs'>
            ...
            <div id="secend_center1" style="float:left;padding:5px; height:500px; width:33%;
             overflow-y:scroll;scrollbar-base-color:#FFF; scrollbar-face-color:#000">
				...
				where tag_player_post like ?";
                    $tag_player_post_res = pdo_query($select_tag_player_post, $tag_player_post);
                    //echo "共计".$rows."行 ".$colums."列<br/>";
                } else {
                    $select_tag_player_post =
                        "select tag_player_post_id,tag_player_post from tag_player_post";
                ...
                <table id='player_grade_tag' width='300px' class='table table-striped'>
                    ...
                    <tr class='toprow'>
                        <th class='hidden-xs' width='5%'>
                            <?php echo $MSG_TAG_PLAYER_POST_ID ?>
                        </th>
                        <th class='hidden-xs' width='20%'>
                    ...
                    foreach ($tag_player_post_res as $row) {
                        $t = 0;
                        echo "<tr>";
                        echo "<td class='hidden-xs'>" . $row['tag_player_post_id'] . "</td>";
                        echo "<td class='hidden-xs'>" . $row['tag_player_post'] . "</td>";
                        ?>
                        <td class='hidden-xs'>
        ...
        <div id="problem_tag" style="float:left;">
            ...
            overflow-y:scroll;scrollbar-base-color:#FFF; scrollbar-face-color:#000">
                ...
                if (isset($_GET['tag1_name'])) {
                    ...
                    $tag1_name = "%$tag1_name%";
                    $select_tag1 = "select tag1_id,tag1_name from tag1 where tag1_name like ?";
                    $tag1_res = pdo_query($select_tag1, $tag1_name);
                    //echo "共计".$rows."行 ".$colums."列<br/>";
                } else {
                    $select_tag1 = "select tag1_id,tag1_name from tag1";
                    $tag1_res = pdo_query($select_tag1);
                    //echo "共计".$rows."行 ".$colums."列<br/>";
                }
                ...
                <table id='tag1' width='300px' class='table table-striped'>
                    ...
                    <tr class='toprow'>
                        <th class='hidden-xs' width='20%'>
                            <?php echo $MSG_TAG_PROBLEM_TAG1_ID ?>
                        </th>
                        <th class='hidden-xs' width='20%'>
                    ...
                    <tbody>
                    <?php
                    foreach ($tag1_res as $row) {
                        $t = 0;
                        echo "<tr>";
                        echo "<td class='hidden-xs'>" . $row['tag1_id'] . "</td>";
                        echo "<td class='hidden-xs'>" . $row['tag1_name'] . "</td>";
                        ?>
                        <td class='hidden-xs'>
            ...
            <div id="secend_center1" style="float:left;padding:5px; height:500px; width:66%;
             overflow-y:scroll;scrollbar-base-color:#FFF; scrollbar-face-color:#000">
				...
				where concat(tag1.tag1_name,tag2.tag2_name) like ?
			    ORDER BY tag2.tag2_tag1_id asc,tag2.tag2_id asc
			    ";
                    $tag2_res = pdo_query($select_tag2, $tag2_select);
                    //echo "共计".$rows."行 ".$colums."列<br/>";
                } else {
                    $select_tag2 =
                        "SELECT tag2.tag2_id,tag2.tag2_tag1_id,tag1.tag1_name,tag2.tag2_name FROM tag1 
			    right join tag2 on tag1.tag1_id=tag2.tag2_tag1_id
			    ORDER BY tag2.tag2_tag1_id asc,tag2.tag2_id asc";
                    $tag2_res = pdo_query($select_tag2);
                    //echo "共计".$rows."行 ".$colums."列<br/>";
                }
                ...
                <table id='player_professional_tag' width='380px' class='table table-striped'>
                    ...
                    <tr class='toprow'>
                        <th class='hidden-xs' width='20%'>
                            <?php echo $MSG_TAG_PROBLEM_TAG2_ID ?>
                        </th>
                        <th class='hidden-xs' width='20%'>
                            <?php echo $MSG_TAG_PROBLEM_TAG1 ?>
                        </th>
                    ...
                    <tbody>
                    <?php
                    foreach ($tag2_res as $row) {
                        $t = 0;
                        echo "<tr>";
                        echo "<td class='hidden-xs'>".$row['tag2.tag2_id']."</td>";
                        echo "<td class='hidden-xs'>".$row['tag1.tag1_name']."</td>";
                        echo "<td class='hidden-xs'>".$row['tag2.tag2_name']."</td>";
                        ?>
                        <td class='hidden-xs'>
            ...
            overflow-y:scroll;scrollbar-base-color:#FFF; scrollbar-face-color:#000">
				...
				where tag_problem_source like ?";
                    $tag_problem_source_res = pdo_query($select_tag_problem_source, $tag_problem_source);
                    //echo "共计".$rows."行 ".$colums."列<br/>";
                } else {
                    $select_tag_problem_source =
                        "select tag_problem_source_id,tag_problem_source from tag_problem_source";
                    $tag_problem_source_res = pdo_query($select_tag_problem_source);
                    //echo "共计".$rows."行 ".$colums."列<br/>";
                }
                ...
                <table id='tag_problem_source' width='300px' class='table table-striped'>
                    ...
                    <tr class='toprow'>
                        <th class='hidden-xs' width='5%'>
                            <?php echo $MSG_TAG_PROBLEM_SOURCE_ID ?>
                        </th>
                        <th class='hidden-xs' width='20%'>
                    ...
                    <tbody>
                    <?php
                    foreach ($tag_problem_source_res as $row) {
                        $t = 0;
                        echo "<tr>";
                        echo "<td class='hidden-xs'>".$row['tag_problem_source_id']."</td>";
                        echo "<td class='hidden-xs'>".$row['tag_problem_source']."</td>";
                        ?>
                        <td class='hidden-xs'>
        ...
        <div id="privilege_tag" style="float:left;">
            ...
            overflow-y:scroll;scrollbar-base-color:#FFF; scrollbar-face-color:#000">
                ...
                <div style=" float:left;margin-right:30px">
                    <!--添加历届队员年级-->
                    <form method=POST action="tag_management.php?add_flag=add_tag_privilege"
                          enctype="multipart/form-data">
				...
				where tag_privilege_name like ?";
                    $tag_privilege_res = pdo_query($select_tag_privilege, $tag_privilege_name);
                    //echo "共计".$rows."行 ".$colums."列<br/>";
                } else {
                    $select_tag_privilege = "select tag_privilege_id,tag_privilege_name from tag_privilege";
                    $tag_privilege_res = pdo_query($select_tag_privilege);
                    //echo "共计".$rows."行 ".$colums."列<br/>";
                }
                ...
                <table id='tag1' width='300px' class='table table-striped'>
                    ...
                    <tbody>
                    <?php
                    foreach ($tag_privilege_res as $row) {
                        $t = 0;
                        echo "<tr>";
                        echo "<td class='hidden-xs'>".$row['tag_privilege_id']."</td>";
                        echo "<td class='hidden-xs'>".$row['tag_privilege_name']."</td>";
                        ?>
                        <td class='hidden-xs'>

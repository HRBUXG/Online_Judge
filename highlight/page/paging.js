(function ($, window, document) {
    ...
    Paging.prototype = {
        ...
        createDom: function () {
            ...
            that.options.jump ? jumpDom =
                '<input type="text" placeholder="1" class="jump-text" id="jumpText"><button type="button" class="jump-button" id="jumpBtn">跳转</button>' : jumpDom = '';
        ...
        bindEvents: function () {
            ...
            prePage.on('click', function () {
                ...
                handles(pageIndex);
                window.location.href = '../../videostudy.php?page=' + pageIndex;
            })

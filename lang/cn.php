...
$MSG_VIDEOSTUDY = "视频学习";
$MSG_VIDEO = "视频";
$MSG_PLAYINFORMATION = "历届队员信息";
$MSG_VIEWNEWS = "查看新闻";
//	新加常亮
$MSG_OTHEROJAC = "其他OJac数";
$MSG_SET_LOGIN_IP = "指定登录IP";
$MSG_DEGREE_OF_DIFFICULTY = "难度系数";
$MSG_PROBLEM_LABEL = "问题标签";

$MSG_USERIDS = "OJ平台账号";
$MSG_NEWCODE = "牛客网";
$MSG_JISUANKE = "计蒜客";
$MSG_HRBUST = "哈尔滨理工大学";
$MSG_PROBLEMINFO = "问题属性";
$MSG_Pending = "等待";
...
//历届队员信息
$MSG_PLAYER = "队员信息";
$MSG_NOW_PLAYINFORMATION = "现届队员信息";
//现届队员信息
$MSG_NOW_HELP_UPDATE_PLAYINFORMATION = "修改现届队员信息";
$MSG_NOW_HELP_ADD_PLAYINFORMATION = "添加现届队员信息";
$MSG_NAME = "队员姓名";
$MSG_USERNAME = "昵称";
$MSG_PTCTURE = "照片";
$MSG_GRADE = "年级";
...
$MSG_PLAYER_POST = "职位";
//历届队员信息
$MSG_PLAYER_UNAME = "队员姓名";
$MSG_PLAYER_USERID = "学号";
$MSG_PLAYER_NICK = "昵称";
$MSG_PLAYER_PTCTURE = "照片";
$MSG_PLAYER_GRADE = "年级";
$MSG_PLAYER_COLLEGE = "学院";
$MSG_PLAYER_PROFESSIONAL = "专业";
$MSG_PLAYER_EMAIL = "邮箱";
$MSG_PLAYER_WORK = "工作单位/研究生就读学校";
$MSG_PLAYER_INTRODUCE = "自我介绍";
$MSG_PLAYER_AWARDS = "获奖状况";
$MSG_HELP_ADD_PLAYINFORMATION = "添加历届队员信息";
$MSG_TAG_PLAYER_GRADE = "历届队员年级标签";
$MSG_TAG_PLAYER_PROFESSOIONAL = "历届队员专业标签";
$MSG_TAG_PLAYER_COLLEGE = "历届队员学院标签";
$MSG_CONTENT = "新闻列表";
//文件处理
$MSG_FILE_NAME = "文件名";
$MSG_FILE_ID = "序列";
$MSG_FILE_DESCRRIBE = "文件描述";
$MSG_FILE_FRAMER = "发布者";
$MSG_FILE_SOURCE = "来源";
$MSG_FILE_UPLOAD_TIME = "上传时间";
$MSG_FILE = "文件";
$MSG_FILE_PRIVILEGE = "文件权限";
$MSG_HELP_ADD_FILE = "上传文件";
$MSG_HELP_UPDATE_FILE = "修改文件";
$MSG_FILE_DOWNLOAD_TOTAL = "文件下载数";
$MSG_FILE_CLASSIFY = "文件分类";

$MSG_BACKGROUND = "背景图片";
$MSG_OTHEROJ = "其他平台数据导入";
$MSG_READYTORUN = "已就绪比赛数";
//Tag
$MSG_MANAGE = "管理";
$MSG_TAG = "标签";
$MSG_HELP_TAG = "用来管理标签";
$MSG_TAG_PROBLEM_SOURCE = "所有问题来源";
//privilege tag
$MSG_TAG_PRIVILEGE = "所有权限标签";
//video tag
$MSG_TAG_VIDEO_DESCRIBE = "所有视频描述标签";
$MSG_TAG_VIDEO_SOURCE = "所有视频来源标签";
$MSG_TAG_VIDEO_FRAMER = "所有视频发布者标签";
//file tag
$MSG_TAG_FILE_DESCRIBE = "所有文件描述标签";
$MSG_TAG_FILE_SOURCE = "所有文件来源标签";
$MSG_TAG_FILE_FRAMER = "所有文件发布者标签";
//ranklist.php
$MSG_Number = "名次";
$MSG_NICK = "姓名";
$MSG_SOVLED = "解决";
...
$MSG_TAG_PROBLEM_TAG1 = "所有问题一级标签";
$MSG_TAG_PROBLEM_TAG2 = "所有问题二级标签";
$MSG_PROBLEM_NEXT = "下一题";
$MSG_PROBLEM_LAST = "上一题";
//admin menu
$MSG_SEEOJ = "查看前台";
$MSG_ADD = "添加";
$MSG_LIST = "列表";
...
$MSG_ONLINE = "在线";
$MSG_IMPORTACC = "外部导入账号";
//video
$MSG_VIDEO_NAME = "名字";
$MGE_VIDEO_DESCRRIBE = "视频描述";
$MSG_VIDEO_FRAMER = "发布者";
$MSG_VIDEO_SOURCE = "来源";
$MSG_VIDEO_UPLOAD_TIME = "上传时间";
$MSG_VIDEOTOTAL = "点击量";
$MSG_VIDEO_PRIVILEGE = "视频权限";
$MSG_CREATEXML = "创建xml";
//contest

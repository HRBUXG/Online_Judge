...
<div class="container">
    ...
    <div class="jumbotron">
        ...
        <a href="pushmsglist.php?page=1">首页</a>&nbsp;&nbsp;&nbsp;
        <a href="pushmsglist.php?page=<?php echo $prev; ?>">上一页</a>&nbsp;&nbsp;&nbsp;
        <!--混编简写-->
        <a href="pushmsglist.php?page=<?= $next; ?>">下一页</a>&nbsp;&nbsp;&nbsp;
        <a href="pushmsglist.php?page=<?= $pageCount; ?>">尾页</a>

...
<!--添加队员标题-->
  ...
  <!--添加历届队员-->
  <div id="add_now_players">
    <form method="POST"  action="update_now_playinformation.php?flagadd=add" name="playinformation" 
    onSubmit="return check()" enctype="multipart/form-data" >
      ...
      <table border="0" bordercolor="#000000" align="center" 
        ...
        <tr>
          ...
          <td>
             <input type="text" value="" name="u_uname" id="player_name" onBlur="checkname()" style="float:left">

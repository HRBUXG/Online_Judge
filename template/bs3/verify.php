...
<div class="jumbotron">
    <form action=verify.php method=post>
        <center>
            <table algin=center>
                <?php $text = '<input name="id" type="hidden" value="' . $id . '">';
                echo $text; ?>
                <tr>
                    <td>Input your excepted password:
                    <td><input name="password" type="password" size=20></td>
                </tr>
                <tr>
                    <td>Reinput your excepted password:
                    <td><input name="repassword" type="password" size=20></td>
                </tr>
                <?php // if($OJ_VCODE){
                ?>
                <tr>

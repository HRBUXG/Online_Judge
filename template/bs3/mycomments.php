...
<div class="container">
    ...
    <div class="jumbotron">
        ...
        //------------分页开始-------------------
        //1.求出总条数
        $sql = "select count(*) as count from comment where  `lock`=0 and  user_id='".$user_id."' ";
        ...
        //6.修改sql语句
        $sql = "select * from comment where `lock`=0 and  user_id='" . $user_id . "' order by sendtime desc  limit " . $offset . ',' . $num;
        ...
        while ($row = mysqli_fetch_assoc($obj)) {
            ...
            echo '<td>【<a href = "./admin/comments_lock.php?id='. $row['id'] . '">删除评论</a>】</td>';
            echo "</tr>";
        }
        ...
        <a href="mycomments.php?page=1">首页</a>&nbsp;&nbsp;&nbsp;
        <a href="mycomments.php?page=<?php echo $prev; ?>">上一页</a>&nbsp;&nbsp;&nbsp;
        <!--混编简写-->
        <a href="mycomments.php?page=<?= $next; ?>">下一页</a>&nbsp;&nbsp;&nbsp;
        <a href="mycomments.php?page=<?= $pageCount; ?>">尾页</a>

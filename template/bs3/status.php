    ...
    <div class="jumbotron">
        <div align=center class="input-append">
            ...
            <form id=simform class=form-inline action="status.php" method="get">
                <?php echo $MSG_PROBLEM_ID ?>:<input class="form-control" style='width:150px' type=text size=4
                                                     name=problem_id
                                                     value='<?php echo htmlspecialchars($problem_id, ENT_QUOTES) ?>'>
                <?php echo $MSG_USER ?>:<input class="form-control" style='width:150px' type=text size=4 name=user_id
                                               value='<?php echo htmlspecialchars($user_id, ENT_QUOTES) ?>'>
                <?php if (isset($cid)) echo "<input type='hidden' name='cid' value='$cid'>"; ?>
                <?php echo $MSG_LANG ?>:<select class="form-control" style='width:150px' size="1" name="language">
                ...
                <?php echo $MSG_RESULT ?>:<select class="form-control" style='width:150px' size="1" name="jresult">
                ...
                <?php if (isset($_SESSION[$OJ_NAME . '_' . 'administrator']) || isset($_SESSION[$OJ_NAME . '_' . 'source_browser'])) {
                    if (isset($_GET['showsim']))
                        ...
                        $showsim = 0;
                    echo "SIM:
<select id=\"appendedInputButton\" class=\"form-control\"  style=\"width:150px\" name=showsim onchange=\"document.getElementById('simform').submit();\">
        ...
        <div id=center>
            <table id=result-tab class="table table-striped content-box-header" align=center width=1000px>
                ...
                <tr class='toprow'>
                    ...
                    <th style='text-align:center'><?php echo $MSG_LANG ?>
